...
(function() {
    ...
    nbfService.$inject = ["$q", "$location", "_", "FacetResultHandler", "SPARQL_ENDPOINT_URL", "AdvancedSparqlService", "personMapperService"];
})();
...
(function() {
    ...
    groupmapService.$inject = ["$q", "$location", "_", "FacetResultHandler", "SPARQL_ENDPOINT_URL", "AdvancedSparqlService", "personMapperService"];
})();
...
(function() {
    ...
    */
    ...
    GroupmapController.$inject = ["$scope", "$location", "$state", "$uibModal", "_", "groupmapService", "FacetHandler", "facetUrlStateHandlerService"];
})();
...
angular.module('facetApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/description.partial.html',
    "<h4>U.S. Congress Legislators</h4> <p> Biographical Repository of the U.S. Congress Legislators. This interface enables you to explore biographical and prosopographical data of the United States Congress. (Edit file 'description.partial.html' to edit this text) Source: <a href=\"https://github.com/unitedstates/congress-legislators\">Members of the United States Congress</a> </p>"
  );


  $templateCache.put('views/description.statistics.partial.html',
    "<h1>Semanttinen Kansallisbiografia</h1> <p> Aineistosta luotuja tilastoja. Esitykset luodaan vasemmanpuoleisissa suodattimissa tehtyjen valintojen perusteella. Lähde: <a href=\"http://www.kansallisbiografia.fi\">Kansallisbiografia</a> </p>"
  );
  ...
  $templateCache.put('views/mapfacets.partial.html',
    "<a href=\"\" ng-click=\"vm.removeFacetSelections()\">Remove all selections</a> <div class=\"facets\"> <seco-jena-text-facet data-options=\"vm.facets.entryText\"></seco-jena-text-facet> <div class=\"show-facets row\"> <div class=\"col-xs-12\"> <button class=\"btn btn-default pull-right visible-xs-block visible-sm-block\" ng-click=\"show = !show\">{{ show ? 'Hide the facets' : 'Show the facets' }}</button> </div> </div> <div class=\"hideable-facets\" ng-class=\"{ 'hidden-sm hidden-xs': !show }\"> <seco-basic-facet data-options=\"vm.facets.familyName\"></seco-basic-facet> <seco-basic-facet data-options=\"vm.facets.givenName\"></seco-basic-facet> <seco-basic-facet data-options=\"vm.facets.gender\"></seco-basic-facet> <seco-basic-facet data-options=\"vm.facets.memberOf\"></seco-basic-facet> <seco-basic-facet data-options=\"vm.facets.state\"></seco-basic-facet> <!--  <seco-basic-facet data-options=\"vm.facets.birthYear\"></seco-basic-facet> --> <seco-basic-facet data-options=\"vm.facets.occupation\"></seco-basic-facet> <seco-hierarchy-facet data-options=\"vm.facets.birthPlace\"></seco-hierarchy-facet> <seco-checkbox-facet data-options=\"vm.facets.link\"></seco-checkbox-facet> </div> </div>"
  );
