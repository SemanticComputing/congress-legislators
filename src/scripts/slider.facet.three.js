(function() {
    ...
    .factory('SliderFacetThree', SliderFacet)
    .controller('SliderFacetController3', SliderFacetController)
    .directive('secoSliderFacetThree', sliderFacet);
    ...
    function sliderFacet() {
        return {
            ...
            controller: 'SliderFacetController3',
            controllerAs: 'vm',
    ...
    function SliderFacetController($scope, _, EVENT_FACET_CHANGED,
            EVENT_REQUEST_CONSTRAINTS, EVENT_INITIAL_CONSTRAINTS, SliderFacetThree) {
        var vm = this;
        ...
        function init() {
            var initListener = $scope.$on(EVENT_INITIAL_CONSTRAINTS, function(event, cons) {
                ...
                opts.update = changed;
                vm.facet = new SliderFacetThree(opts);
    ...
    function SliderFacet(_) {
        ...
        function SliderFacet(options) {
            ...
            var min = parseInt(this.config.min) || 33;
