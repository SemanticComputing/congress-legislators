...
(function() {
    ...
    */
    .controller('GroupmapControllerR', GroupmapControllerR);

    /* @ngInject */
    function GroupmapControllerR($scope, $location, $state, $uibModal, _, groupmapServiceR,
...
vm.closeWindow = function() {
  vm.window.show = false;
        ...
        vm.getSortClass = groupmapServiceR.getSortClass;
        ...
        groupmapServiceR.getFacets().then(function(facets) {
            vm.facets = facets;
        ...
        function getFacetOptions() {
            var options = groupmapServiceR.getFacetOptions();
        ...
        function sortBy(sortBy) {
        	groupmapServiceR.updateSortBy(sortBy);
        ...
        function fetchResults(facetSelections) {
            ...
            return groupmapServiceR.getResults(facetSelections)
            .then(function(res) {
