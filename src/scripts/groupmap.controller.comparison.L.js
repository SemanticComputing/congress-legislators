...
(function() {
    ...
    */
    .controller('GroupmapControllerL', GroupmapControllerL);

    /* @ngInject */
    function GroupmapControllerL($scope, $location, $state, $uibModal, _, groupmapServiceL,
...
vm.closeWindow = function() {
  vm.window.show = false;
        ...
        vm.getSortClass = groupmapServiceL.getSortClass;
        ...
        groupmapServiceL.getFacets().then(function(facets) {
            vm.facets = facets;
        ...
        function getFacetOptions() {
            var options = groupmapServiceL.getFacetOptions();
        ...
        function sortBy(sortBy) {
        	groupmapServiceL.updateSortBy(sortBy);
        ...
        function fetchResults(facetSelections) {
            ...
            return groupmapServiceL.getResults(facetSelections)
            .then(function(res) {
