(function() {
    ...
    .factory('SliderFacetTwo', SliderFacet)
    .controller('SliderFacetController2', SliderFacetController)
    .directive('secoSliderFacetTwo', sliderFacet);
    ...
    function sliderFacet() {
        return {
            ...
            controller: 'SliderFacetController2',
            controllerAs: 'vm',
    ...
    function SliderFacetController($scope, _, EVENT_FACET_CHANGED,
            EVENT_REQUEST_CONSTRAINTS, EVENT_INITIAL_CONSTRAINTS, SliderFacetTwo) {
        var vm = this;
        ...
        function init() {
            var initListener = $scope.$on(EVENT_INITIAL_CONSTRAINTS, function(event, cons) {
                ...
                opts.update = changed;
                vm.facet = new SliderFacetTwo(opts);
    ...
    function SliderFacet(_) {
        ...
        function SliderFacet(options) {
            ...
            var min = parseInt(this.config.min) || 20;
