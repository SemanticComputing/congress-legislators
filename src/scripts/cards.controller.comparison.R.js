...
(function() {
    ...
    */
    .controller('CardsControllerComparisonR', CardsControllerComparisonR);

    /* @ngInject */
    function CardsControllerComparisonR($scope, $location, $state, $uibModal, _, comparisonServiceR,
        ...
        vm.sortBy = sortBy;
        vm.getSortClass = comparisonServiceR.getSortClass;
        ...
        comparisonServiceR.getFacets().then(function(facets) {
            vm.facets = facets;
        ...
        function getFacetOptions() {
            var options = comparisonServiceR.getFacetOptions();
        ...
        function sortBy(sortBy) {
        	comparisonServiceR.updateSortBy(sortBy);
        ...
        function fetchResults(facetSelections) {
            ...
            nextPageNo = 0;
            comparisonServiceR.getResults(facetSelections)
            .then(function(pager) {
