...
(function() {
    ...
    */
    .controller('VisuController2L', VisuController2L);

    /* @ngInject */
    function VisuController2L($scope, $location, $q, $state, _, visucomserviceL,
...
console.log(res);
      ...
      var
        ...
        function fetchResults(facetSelections) {
            ...
            return visucomserviceL.getResults(facetSelections).then(function(res) {
